...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BuildWorks — Engineering & Construction Project Management" },
      { name: "description", content: "Engineering and construction services with a live project dashboard for owners and contractors." },
